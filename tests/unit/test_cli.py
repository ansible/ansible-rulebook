...
from ansible_rulebook.cli import get_version, main, validate_controller_url
...
def test_validate_controller_url(url, expected_bool):
    res = validate_controller_url(url)
