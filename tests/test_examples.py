...
@pytest.mark.asyncio
async def test_33_multiple_rulesets():
    ruleset_queues, event_log = load_rules(
        "examples/33_multiple_rulesets.yml"
    )
...
@pytest.mark.asyncio
async def test_34_multiple_rulesets():
    ruleset_queues, event_log = load_rules(
        "examples/34_multiple_rulesets.yml"
    )
